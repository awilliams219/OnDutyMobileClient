...
namespace OnDuty.iOS
{
    public class Application
    {
        ...
        public static async Task<ApparatusModel> Test() {

            API.Apparatus apparatus = new API.Apparatus("http://localhost/app_dev.php/api");
            ApparatusModel gottenApparatus = await apparatus.Read(1);
            return gottenApparatus;
        }
